...
/_/ |_| \__,_/ _  .___/_  .___//_/  \___/      \____/  /_/ /_/\__,_/ \__/        /_.___/\____/\__/  
    ...
    ");
        ...
        {
            Console.WriteLine($"Hello {user.Name}, I'm KappieChatBot! How can I assist you today?");
            // Add chat logic here
        ...
        private void Respond(string input)
        {
            ...
            {
                Console.WriteLine("Bot: I'm here to assist you with any questions you have. What do you need help with?");
            }
            ...
            {
                Console.WriteLine("Bot: Phishing is a type of cyber attack where attackers impersonate legitimate organizations to steal sensitive information. Always be cautious of unsolicited emails and messages, and never click on suspicious links.");
            }
            ...
            {
                Console.WriteLine("Bot: A VPN (Virtual Private Network) encrypts your internet connection and hides your IP address, providing increased privacy and security online. It's a good idea to use a VPN when connecting to public Wi-Fi networks.");
            }
